...
const eye = (x, expression) => expression === 'closed' ? `<path d="M${x} 10h6v2h-6z" fill="#11170e"/>`
  ...
  : `<rect x="${x}" y="5" width="7" height="10" fill="#f5f0ce"/><rect x="${x+3}" y="7" width="4" height="7" fill="#112a16"/><rect x="${x+3}" y="7" width="2" height="2" fill="#fffdf0"/>${expression === 'half' ? `<rect x="${x}" y="5" width="7" height="4" fill="#759735"/>` : ''}`;
...
<path d="M7 17h5v2h15v1h-5v2H11v-2H7z" fill="#e4e49c"/>
${eye(11,expression)}${eye(21,expression)}
<path d="M17 17h5v1h6v-1h2v2h-8v-1h-5z" fill="#172514"/>
</g></g>`).join('\n');
