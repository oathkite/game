...
const files = ['cabin-standard', 'tracks-standard', 'pilot-frog', 'effect-smoke', 'effect-dust', 'effect-muzzle', 'effect-explosion', 'effect-energy', 'effect-drill', 'effect-dig', ...['cannon', 'triple', 'multiple', 'drill', 'laser', 'digger', 'floater', 'stinger'].flatMap(id => [`weapon-${id}`, `projectile-${id}`])];
