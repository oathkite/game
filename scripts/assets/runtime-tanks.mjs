...
const files = ['cabin-standard', 'tracks-standard', 'pilot-frog', 'effect-explosion', 'effect-energy', 'effect-drill', 'effect-dig', ...['cannon', 'triple', 'multiple', 'drill', 'laser', 'digger', 'floater', 'stinger'].map(id => `weapon-${id}`)];
