export const roomEnglish: Readonly<Record<string, string>> = {
  ...
  "診断情報をコピー": "Copy diagnostics", "コピーしました": "Copied", "設定を開く": "Open settings", "手番": "Active turn", "試合成績": "Match statistics", "発射数": "Shots", "敵へのダメージ": "Enemy damage", "味方へのダメージ": "Ally damage", "自分へのダメージ": "Self damage", "あなたの手番です": "Your turn", "{order}人後の手番": "Turn in {order}", "風": "Wind", "残り移動": "Steps left",
