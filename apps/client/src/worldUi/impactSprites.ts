...
const effectOf: Record<WeaponId, string> = { cannon: "explosion", triple: "explosion", multiple: "explosion", floater: "explosion", stinger: "explosion", laser: "energy", drill: "drill", digger: "explosion" };
