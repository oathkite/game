...
it("keeps the invitation token out of the HTTP URL query", () => {
  const url = new URL(roomInviteUrl("https://game.example/?token=private#old", "ABCDEF", "00000000-0000-4000-8000-000000000001"));
  expect(url.search).toBe("?room=ABCDEF");
  expect(url.hash).toBe("#invite=00000000-0000-4000-8000-000000000001");
});
