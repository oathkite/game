...
export default defineConfig({ testDir: "./rooms-tests", workers: 1, timeout: 45000, reporter: "list",
  use: { baseURL: "http://127.0.0.1:5186", actionTimeout: 5000, trace: "retain-on-failure" },
  webServer: [
