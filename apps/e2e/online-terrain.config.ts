...
export default defineConfig({
  ...
  projects: [{ name: "chromium", metadata: { mapId: "rock-arch", measureTransfer: true }, use: { browserName: "chromium" } }, { name: "firefox", metadata: { mapId: "rock-arch", measureTransfer: true }, use: { browserName: "firefox" } }, { name: "webkit", metadata: { mapId: "rock-arch", measureTransfer: true }, use: { browserName: "webkit" } }],
