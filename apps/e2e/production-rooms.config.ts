...
export default defineConfig({
  testDir: "./rooms-tests", testMatch: ["eight-players.spec.ts", "result-timeout.spec.ts", "formations.spec.ts", "public-rooms.spec.ts"], workers: 1, timeout: 120000, reporter: "list",
