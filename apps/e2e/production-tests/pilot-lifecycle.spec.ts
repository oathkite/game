...
import { enterFreePractice } from "../world-tests/practiceFlow";
  ...
  await page.addInitScript(() => {
    ...
    for (const prototype of [WebGLRenderingContext.prototype, WebGL2RenderingContext.prototype]) {
      ...
      prototype.texImage2D = function (this: WebGLRenderingContext | WebGL2RenderingContext, ...args: Parameters<typeof original>) {
        if (args.some(value => value instanceof HTMLImageElement && value.src.startsWith("data:image/svg+xml"))) state.pilotUploads!++;
