...
| 画像地形の通常3マップ展開 | rock-arch v2、reed-hills v3、moss-valley v3を登録。画像alphaと共通初期solid列・保存復元・版別素材を接続 | 各マップの3browser・2context射撃/再接続は記録済み。旧版の保存試合は旧地形を維持。詳細はdesign/34-image-terrain-migration.md |
