...
| 初期タイトル転送2MB | production-tests/entry.spec.ts、cold新context、1,861,218B | ローカル配信buildで通過。実地域の起動時間とは別 |
| 初回対戦まで8MB | ポートレート追加後のChromium練習6,323,449B、独立8 contextは各6,325,646B | 練習・8人オンラインを最新素材でChromium通過。Firefox/WebKitは追加前の素材で通過。実地域の待ち時間とは別 |
