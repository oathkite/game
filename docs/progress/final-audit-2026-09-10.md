...
| 代表編成の実ブラウザE2E（22.8） | 4v4は3browser検証済み。formations.spec.tsで1v7、8人FFA、2v2v2、1v1v1v2を追加し、開発版/配信buildともChromium4件成功 | 代表編成の入室→チーム設定→1発の射撃共有→降参による決着→成績/勝敗一致→全員帰還を確認。追加4編成のFirefox/WebKitと人間のバランス評価は別 |
