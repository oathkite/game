...
| 地形checkpointと短いevent log（23.5） | 地形opを別SQL表へ1回ずつ保存し、移動時の本体書込を約17〜19KB→約9〜10KBへ削減 | 旧形式・欠損・rollback・再戦・SIGKILL復元を確認。圧縮checkpoint＋短い末尾opによる復元は未実装。evidence/storage/2026-09-11-split.md |
