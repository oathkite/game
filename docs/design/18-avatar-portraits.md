...
所有区分・カスタマイズの正本は[17章](17-avatar-customization.md)。今後の種族共通フォルムと汎用装備は[19章](19-avatar-form-and-parts.md)。現行の3レイヤーは本人用プレビューの既存形式であり、9slot対応済みではない。今回は本人専用KITAの制作プレビューであり、一般用アバターではない。
