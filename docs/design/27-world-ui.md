...
全シーンはシャッターで切り替える。シャッターは上から下りる。2026-09-23 から、対戦へ入るときだけ中央から開く走査線にする（[38.6](38-motion-enrichment.md#386-ページ切り替えとリザルト)）。reduced-motionでは即時切替。初期表示は自動再生動画ではなく軽い葉の動き。
